...
class UsuarioModel extends BaseModel
{
    ...
    {
        $this->query("INSERT INTO usuarios (nome, login, senha) VALUES (:nome, :login, :senha)", [
    ...
    {
        $stmt = $this->query("SELECT * FROM usuarios WHERE id = :id", [':id' => $id]);
    ...
    {
        $this->query("UPDATE usuarios SET nome = :nome, senha = :senha WHERE id = :id", [
            ':nome' => $usuario->getNome(),
            ':senha' => $usuario->getSenha(),
            ':id' => $usuario->getId()
        ]);
    ...
    {
        $stmt = $this->query("SELECT * FROM usuarios WHERE login = :login", [':login' => $login]);
